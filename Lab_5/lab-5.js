window.onload = function () {
  ...
  // resulting array format: X coefficient, Y coefficient, XY coefficient, intercept.
  var result = [0, 0, 0, 0];
  var correction = 1;
  var canvas = Canvas();
  canvas.Init("canvas");
  ...
  document.getElementById("res").innerHTML = "Separating function: " + resultToString(result);
  ...
  btn0.onclick = function () {
    ...
    document.getElementById("text").innerHTML = "Belongs to class " + (temp + 1);
  ...
  // Find the value of the function with the given coordinates at the next point.
