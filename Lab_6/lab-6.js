window.onload = function () {
  ...
  // Array of all distances without repetitions and sorted.
  var pointsArray = [];
  // Array of all distances to be drawn.
  var distanceArray = [];
  // Array of elements in their order of drawing on the chart.
  var graphArray = [];
  ...
  function unionArray(arr1, arr2) {
    ...
    // Form a new array without duplicate elements.
    var arr = [arr3[0]];
